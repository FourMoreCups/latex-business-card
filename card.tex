...
\foreach \i in {0,1} \foreach \j in {0,1,2,3,4} {
   ...
   \begin{pspicture} (12mm,32mm)
   			\psbarcode{URL:https://www.seandeaton.com}{eclevel=M width=1.0 height=1.0}{qrcode}
   		\end{pspicture}
   };
   
   % logo
   \node at (\i*\cardw+0.8\cardw,\j*\cardh+0.7\cardh) {\includegraphics[width=0.30\cardw]{cyber}};
